...
public class TC5_GetApiStudentByPL {
	...
	public void getApiBatchStudentByNameTest() throws Exception {
		...
		List<Map<String, Object>> students = jsonPath.getList("$");

		for (Map<String, Object> student : students) {
			List<String> programmingLanguagesList = (List<String>) student.get("programming_languages");
			System.out.println("Programming Languages for " + student.get("name") + ": " + programmingLanguagesList);
		}
