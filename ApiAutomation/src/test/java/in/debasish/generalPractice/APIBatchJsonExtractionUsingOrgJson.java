...
public class APIBatchJsonExtractionUsingOrgJson {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < batchStudents.length(); i++) {
			...
			String email = student.has("email") ? student.getString("email") : "N/A";
