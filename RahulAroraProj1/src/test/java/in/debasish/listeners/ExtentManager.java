...
public class ExtentManager {
	...
	public static String fileName;
	    ...
	    public static ExtentReports createInstance(String fileName) {
	        ...
	        extent.setSystemInfo("Automation Tester", "Debasish Pruseth");
	        extent.setSystemInfo("Organization", "Impelsys");
		...
		public static void captureScreenshot() throws IOException {
			...
			FileUtils.copyFile(screeshot, new File(".//target//surefire-reports//Data Driven Basics//"+fileName));
		}
